...
public class Report
{
    ...
    public void addDeviceEvent(String event, double time, int requestSource, int requestNumber, int devicePos, double timeInside)
    {
    ...
    public void printEventStatistics()
    {
        ...
        for (Application application : devices) {
            System.out.println(application != null ? " Device " + i + " | working on " + application.getSourceNumber() + " "
                    + application.getRequestNumber() + " application" : " Device " + i + " | is available");
            i++;
        }
    }
